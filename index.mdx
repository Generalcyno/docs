---
title: "Introduction"
description: "Welcome to D-gen bot documentation. Your free utility bot offering tons of free features."
---
...
Add the bot to a server by [Clicking here](https://discord.com/oauth2/authorize?client_id=1328237652948025425) or going to the bot dashboard.

<Card icon="rocket" horizontal href="/quickstart" title="Start here">
  Follow our three step quickstart guide.
</Card>

```typescript Example of type.ts wrap twoslash
// type.ts
type User = { 
	id: string; 
	address: {
...
//Then you can assign type like this
const user: User = {
id: 'newUsre120',
// Not passing a required property will throw error
}
```
